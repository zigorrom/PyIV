...
class Ui_TimetraceView(object):
    def setupUi(self, TimetraceView):
        ...
        self.stop_button = QtGui.QPushButton(self.dockWidgetContents_6)
        self.stop_button.setObjectName(_fromUtf8("stop_button"))
        self.gridLayout_5.addWidget(self.stop_button, 7, 1, 1, 1)
        self.start_button = QtGui.QPushButton(self.dockWidgetContents_6)
        self.start_button.setObjectName(_fromUtf8("start_button"))
        self.gridLayout_5.addWidget(self.start_button, 7, 0, 1, 1)
    ...
    def retranslateUi(self, TimetraceView):
        ...
        self.stop_button.setText(_translate("TimetraceView", "Stop", None))
        self.start_button.setText(_translate("TimetraceView", "Start", None))
